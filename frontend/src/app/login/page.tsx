        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            <h1 className="animate-element animate-delay-100 text-4xl md:text-5xl font-semibold leading-tight">
                <span className="font-light text-foreground tracking-tighter">Welcome</span> Back
            </h1>
            <p className="animate-element animate-delay-200 text-muted-foreground">Access your notes and continue your productivity journey with us</p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <a href="#" className="hover:underline text-violet-400 font-medium transition-colors">Reset password</a>
              </div>
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              New to our platform? <Link href="/register" className="text-violet-400 font-bold hover:underline transition-colors">Create Account</Link>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="hidden md:block flex-1 relative p-4">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-4 px-8 w-full justify-center">
            <TestimonialCard 
                name="Sarah Johnson" 
                handle="@sarahj_ai" 
                text="Brainstorm has completely changed how I organize my research. The AI summaries are spot on!"
            ...
            <div className="hidden xl:flex">
                <TestimonialCard 
                    name="David Chen" 
                    handle="@dchen_dev" 
                    text="The ultimate tool for developers to keep track of their snippets and ideas. Loving the glass UI!"
